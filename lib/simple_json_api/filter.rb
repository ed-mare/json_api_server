module SimpleJsonApi # :nodoc:
  ...
  # SimpleJsonApi::BadRequest exception is raised which renders a 400 error.
  #
  ...
  # - <tt>pg_ilike</tt>: SimpleJsonApi::PgIlike
  #
  # For searching a JSONB array - case sensitive:
  # - <tt>pg_jsonb_array</tt>: SimpleJsonApi::PgJsonbArray
  #
  # For searching a JSONB array - case insensitive:
  # - <tt>pg_jsonb_ilike_array</tt>: SimpleJsonApi::PgJsonbIlikeArray
  #
  #
  # ====== builder: :model_query
  #
  ...
  # is in SimpleJsonApi::Configuration.
  #
  #  [
  #    { tags: { builder: :pg_jsonb_ilike_array } }
  #  ]
  ...
  # === Custom Filters
  #
  # Custom filters can be added. Filters should inherit from SimpleJsonApi::FilterBuilder.
  #
  # Example:
  #
  #  # In config/initializers/simple_json_api.rb
  #
  ...
  class Filter
    ...
    # SimpleJsonApi::BadRequest with descriptive message if attribute
    # is not whitelisted.
    def config_for(attr)
