...
describe JsonApiServer::RelationshipsBuilder do
  class PeopleSerializer < JsonApiServer::ResourceSerializer
    def links
  ...
  class ComSerializer < JsonApiServer::ResourceSerializer
  ...
  let(:includes) { JsonApiServer::Include.new(request, nil, %w[comments author]) }
  ...
  describe '#initialize' do
    let(:rb) { JsonApiServer::RelationshipsBuilder.new }
  ...
  describe '#relate' do
    it 'merges relationships into a hash' do
      ...
      r = JsonApiServer::RelationshipsBuilder.new
  ...
  describe '#include' do
    ...
    it 'adds to relationships if :relate option is specified' do
      b = JsonApiServer::RelationshipsBuilder.new
