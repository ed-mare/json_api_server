...
describe JsonApiServer::BaseSerializer do
  ...
  describe '#serializer_options' do
    ...
    it 'default to JsonApiServer.configuration.serializer_options' do
      expect(my_class.serializer_options).to eq(JsonApiServer.configuration.serializer_options)
    end
