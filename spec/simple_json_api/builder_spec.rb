...
describe SimpleJsonApi::Builder do
  ...
  describe '#pagination' do
    let(:builder) do
      SimpleJsonApi::Builder.new(request_1, Topic.order(id: :desc))
    ...
    it 'includes pagination when added' do
      expect(builder.pagination).to be_a(SimpleJsonApi::Pagination)
  ...
  describe '#sort' do
    let(:builder) do
      SimpleJsonApi::Builder.new(request_1, Topic.all)
                            .add_sort(sort_options)
    end

    it 'includes sort when added' do
      expect(builder.sort).to be_a(SimpleJsonApi::Sort)
    ...
    it 'raises an exception on invalid sort params' do
      ...
      builder = SimpleJsonApi::Builder.new(req, Topic.all)
                                      .add_sort(sort_options)
      expect { builder.relation }.to raise_exception(SimpleJsonApi::BadRequest, /Sort param 'foobar' is not supported/)
    end
  end
  ...
  describe '#include' do
    ...
    it 'includes include when added' do
      expect(builder.include).to be_a(SimpleJsonApi::Include)
    ...
    it 'raises an exception on invalid include params' do
      builder = SimpleJsonApi::Builder.new(request_3, Topic.all)
                                      .add_include(include_permitted)
      expect { builder.relation }.to raise_exception(SimpleJsonApi::BadRequest, /Inclusion param 'comments' is not supported/)
    end
  end
  ...
  describe '#filter' do
    # "filter" => { "book" => "harry" }
    let(:builder) do
      SimpleJsonApi::Builder.new(request_3, Topic.all)
                            .add_filter(filter_permitted)
    end

    it 'includes filter when added' do
      expect(builder.filter).to be_a(SimpleJsonApi::Filter)
    ...
    it 'raises an exception on invalid filter params' do
      # "filter" => { "quote" => "swear" }
      builder = SimpleJsonApi::Builder.new(request_2, Topic.all)
                                      .add_filter(filter_permitted)
      expect { builder.relation }.to raise_exception(SimpleJsonApi::BadRequest, /Filter param 'quote' is not supported/)
    end
  end
  ...
  describe '#relation' do
    let(:builder) do
      ...
      SimpleJsonApi::Builder.new(req, Topic.order(id: :desc))
                            .add_pagination(pagination_options)
                            .add_sort(sort_options)
                            .add_include(include_permitted)
                            .add_filter(filter_permitted)
  ...
  describe '#includes' do
    ...
    let(:builder_no_includes_requested) do
      SimpleJsonApi::Builder.new(request_4, Topic.all)
                            .add_include(include_permitted)
    end
  ...
  describe '#sparse_fields' do
    let(:builder) { SimpleJsonApi::Builder.new(request_5, Topic.all).add_fields }
    let(:builder_no_add_fields) { SimpleJsonApi::Builder.new(request_5, Topic.all) }
    let(:builder_no_fields_requested) { SimpleJsonApi::Builder.new(request_4, Topic.all).add_fields }
